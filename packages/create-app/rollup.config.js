...
const configuration = () => [{
    ...
    {
        input: path.join(__dirname, 'src/plopfile.ts'),
        output: [{
            file: path.join(distDir(__dirname), 'plopfile.js'),
            format: 'esm',
            exports: 'auto',
        }, ],
        plugins: createAppPlugins.concat(copyTemplatePlugins),
        external: createAppExternal,
    },
]
